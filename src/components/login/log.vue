<template>
    <section class="Log">
        <div class="Log_info">
            ...
            <p class="Log_info_text">Увійдіть, щоб використовувати всі можливості особистого кабінету: відстеження
            ...
            <div class="login-form">
                <form @submit.prevent="login">
                    <div class="form-group">
                        <input type="text" id="contact" v-model="contact" placeholder="Телефон або E-mail" required
                            class="in_info" />
                    </div>
                    <div class="form-group">
            ...
            axios.post('http://localhost/agrar_shop/Backend/login.php', formData)
                .then(response => {
                    ...
                    if (response.data.success) {
                        ...
                        // Можливо перенаправлення користувача на іншу сторінку після успішного входу
                    }
                })
                .catch(error => {
